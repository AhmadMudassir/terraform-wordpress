...
sudo mysql -e "CREATE USER IF NOT EXISTS 'wpuser'@'localhost' IDENTIFIED BY 'wppassword';"
...
sudo -u www-data sed -i 's/password_here/wppassword/' /srv/www/wordpress/wp-config.php
